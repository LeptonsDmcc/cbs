...
const HomePage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    const newData = {
      ...
      "check_in": "8:45",
      "check_out": "9:45",
      "staff": "623dcdee-feb2-454c-a9ed-4775e909c616",
      "vehicle": data.vehicle,
      "destinations": [{
        "address": "Office",
        "mission": data.mission,
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 mb-6">
      <div className="flex justify-center gap-x-[80px] px-5 mt-24 text-bold">
        <ul className='font-bold mx-8'>
          {data && data.results && data.results.map((vehicle, index) => {
            return (
             ...
             setActiveIndex(index) } } key={vehicle.id}>
        ...
        <div className="w-1/2">
          {data && data.results && <img src={data.results[activeIndex].image || peugeot} 
          alt="" className="w-full rounded-lg shadow-lg" />}
        </div>
      ...
      <div className="w-[60%] bg-[#dbded4] mx-auto mt-6 mb-[40px] p-6 rounded-lg shadow-xl transform hover:scale-105 transition duration-300 ease-in-out ">
        <div>
          ...
          {/* <div className="mb-4">
            <label htmlFor="location" className="block text-sm font-medium text-gray-700">Destination</label>
            <div className="relative rounded-md">
            <GeoapifyContext apiKey="77a6a0616fbd4d22ae652b352b03f67b">
  ...
  />
          ...
          <div className="flex-grow">
              <label htmlFor="destinations" className="block text-sm font-medium text-gray-700">Destination</label>
              <input {...register("destinations")} type="text" id="destinations" name="destinations" className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none shadow-lg focus:ring-2 focus:ring-blue-500 font-bold text-gray-600" />
            </div>
...
//         "address": address,
//         "mission": data.mission,
//         "visit_duration": "1 hour" // Adjust this value as needed
//       }]
//     };
...
//               return (
//                 <li onClick={() => setActiveIndex(index)} key={vehicle.id}>
//                   <label className={`${activeIndex === index ? "bg-[#a8cf45] text-gray-800 shadow-lg" : "shadow-md"} block min-w-[255px] my-1 p-4 cursor-pointer hover:bg-[#a8cf45] text-gray-500 border py-3 text-center transition duration-300 ease-in-out transform hover:scale-105 hover:text-gray-800 rounded-md`} htmlFor={vehicle.url}>
//                     {vehicle.make + " " + vehicle.model}
//                     <input hidden type="radio" value={getIDFromUrl(vehicle.url)} name="vehicle" id={vehicle.url} {...register("vehicle")} />
//                   </label>
//                 </li>
...
//         <div className="w-[60%] bg-[#e9f4cd] mx-auto mt-6 mb-[40px] p-6 rounded-lg shadow-xl transform hover:scale-105 transition duration-300 ease-in-out ">
//           <div>
//             <div className="mb-4 flex gap-6 items-center">
//               <div className="flex-grow">
//                 <label htmlFor="date" className="block text-sm font-medium text-gray-700"> Date </label>
