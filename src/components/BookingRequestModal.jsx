...
const AcceptedBookingModal = ({ isOpen, onClose, trip, handleAddTrip, handleStartTrip }) => {
    ...
    <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
      <div className="bg-white p-6 rounded shadow-lg w-1/3">
        ...
        <div className="mt-4 flex justify-end space-x-4">
          ...
          <button onClick={handleStartTrip} className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
            Start Trip
          </button>
